...
async def main():
    task = """
      Perform the following browser navigation related to the academic topic 'Artificial Intelligence':
    ...
    llm = ChatOpenAI(model="gpt-4o")  # or gpt-4, gpt-4o-mini depending on access
